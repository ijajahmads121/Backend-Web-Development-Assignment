...
// A readFile call stores the entire file in memory before the application can use it,
// so memory usage grows with the file size. A stream moves the file in small chunks,
// keeping peak memory usage low and predictable even when the file is very large.
//
